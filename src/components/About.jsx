  ...
  return (
    <div>
      ...
      <h3 className="text-lg">
        Hi, I&#39;m Connor - a versatile, hardworking software developer
        who&#39;s committed to building a successful career in software
        development.
      </h3>
      <p>
        I&#39;m proficient in full-stack JavaScript (including React, Next.js,
        Node.js, Express, and Jest), (maybe include SOLID principles) including
        testing, debugging, and data handling. I&#39;m eager for an opportunity
        to apply and grow my software development knowledge and skills!
      </p>
      <Tools />
      <p>
        My educational background prepared me for work as a chaplain or pastor -
      ...
      <p>
        I began my coding journey in late 2021. I had always been
        ...
        and proceeded to buy all the parts and assemble my own desktop, which
        served me faithfully for the better part of a decade. I found The Odin
        Project, a web development curriculum curated by others who had taught
      ...
      <p>
        ...
        up with) Amity Warme, a professional rock climber. We travel across the
        western US in search of epic climbing objectives and suitable weather. I
        enjoy pursuing mountain adventures (skiing, climbing, biking, trail
        running). I also enjoy spending quality time with family and friends,
        scheming and dreaming about our next adventure rig, and reading.
      </p>
    </div>
  )
}
